...
build: $(BOOTSTRAP_FILE) $(KERNEL_FILE)
	...
	ld -melf_i386 -Tlinker.ld starter.o kernel.elf screen.elf process.elf scheduler.elf heap.elf paging.elf -o minos.elf
	objcopy -O binary minos.elf minos.bin
	dd if=bootstrap.o of=kernel.img
	dd seek=1 conv=sync if=minos.bin of=kernel.img bs=512 count=8
